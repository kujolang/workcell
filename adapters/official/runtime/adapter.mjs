#!/usr/bin/env node
import { assertDestroyOwnership, describe, envelope, event, fixture, readRequest, redactError, resolve, validateProfile } from './protocol.mjs';
...
try {
  ...
  if (req.operation === 'destroy') assertDestroyOwnership(provider, req);
  let value;
