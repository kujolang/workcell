...
- Pinned Kujo example image: `./docker/kujo/build-local.sh ../kujo` passed using Kujo commit `475fb1a6ee88b53b799cd1a62e5e771517406da8` and digest-pinned Rust/Alpine base images.
