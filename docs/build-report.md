...
- Offline tests: `KUJO=../kujo/target/release/kujo ./tests/run.sh` — passed 39 definition/policy assertions plus 7 workspace patch/change-report assertions, including path-safety, dry-run lifecycle, partial-default, empty-secret, binary-report, digest, namespace, and null-output regressions.
