...
- Performance harness resilience: the default suite also runs `WORKCELL_PERF_FILES=999999999999999999999` and confirms the bounded 202-file signal completes without a VM crash.
...
- Pinned Kujo example image: `./docker/kujo/build-local.sh ../kujo` passed using Kujo commit `475fb1a6ee88b53b799cd1a62e5e771517906da8` and digest-pinned Rust/Alpine base images.
