...
The rootless Docker path has been exercised on a Linux Colima VM, including the rootless workspace identity, fail-closed identity mismatch, Docker integration matrix, and resource cleanup contracts. See [the dated evidence record](compatibility/rootless-docker-colima-2026-07-13.md). Podman rootless and hosted CI remain separate deployment prerequisites.
