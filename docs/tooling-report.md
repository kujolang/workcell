...
- The final offline suite passed 43 definition/policy assertions and 7 workspace patch/change-report assertions; example definitions and CLI smoke fixtures also passed.
