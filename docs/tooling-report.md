...
The 192-assertion figure in the historical bullet below predates iteration 065; the current Workcell total is 194.
...
The current Workcell suite is 194 assertions plus 27 workspace and 7 stress assertions after iteration 065's malformed secret and image-ensure boundary regressions.
