...
reject_definition "host-control-set" '.environment.set = {"DOCKER_HOST":"tcp://docker.example:2375"}'
reject_definition "lowercase-proxy-allow" '.environment.allow = ["http_proxy"]'
