...
check_all() {
  ...
  "$KUJO" check "$ROOT/tests/backend_test.kujo"
  "$KUJO" check "$ROOT/tests/package_test.kujo"
  "$KUJO" check "$ROOT/tests/artifact_archive_test.kujo"
  "$KUJO" check "$ROOT/tests/evidence_recovery_test.kujo"
  "$KUJO" check "$ROOT/tests/conformance_test.kujo"
  "$KUJO" check "$ROOT/tests/portable_definition_test.kujo"
  "$KUJO" check "$ROOT/tests/portable_coordinator_test.kujo"
  "$KUJO" check "$ROOT/tests/official_adapters_test.kujo"
  ...
  bash -n "$ROOT/tests/portable_oci_contract.sh"
  bash -n "$ROOT/tests/live_certification.sh"
  bash -n "$ROOT/tests/live_certification_contract.sh"
  bash -n "$ROOT/tests/adapter_release_candidate.sh"
  bash -n "$ROOT/tests/secret_scope_contract.sh"
...
"$KUJO" run "$ROOT/tests/backend_test.kujo"
"$KUJO" run "$ROOT/tests/package_test.kujo"
"$KUJO" run "$ROOT/tests/artifact_archive_test.kujo"
"$KUJO" run "$ROOT/tests/evidence_recovery_test.kujo"
"$KUJO" run "$ROOT/tests/conformance_test.kujo"
"$KUJO" run "$ROOT/tests/portable_definition_test.kujo"
"$KUJO" run "$ROOT/tests/portable_coordinator_test.kujo"
"$KUJO" run "$ROOT/tests/official_adapters_test.kujo"
...
KUJO="$KUJO" "$ROOT/tests/portable_oci_contract.sh"
KUJO="$KUJO" "$ROOT/tests/live_certification_contract.sh"
"$ROOT/tests/adapter_release_candidate.sh"
KUJO="$KUJO" "$ROOT/tests/secret_scope_contract.sh"
