...
check_all() {
  ...
  "$KUJO" check "$ROOT/tests/preservation_test.kujo"
  "$KUJO" check "$ROOT/tests/execution_result_test.kujo"
  "$KUJO" check "$ROOT/tests/retention_test.kujo"
  ...
  bash -n "$ROOT/tests/cloudflare_sandbox_preflight.sh"
  bash -n "$ROOT/scripts/cloudflare-sandbox-preflight.sh"
...
"$KUJO" run "$ROOT/tests/preservation_test.kujo"
"$KUJO" run "$ROOT/tests/execution_result_test.kujo"
"$KUJO" run "$ROOT/tests/retention_test.kujo"
...
"$ROOT/tests/cloudflare_sandbox_preflight.sh"
...
KUJO="$KUJO" python3 "$ROOT/tests/docker_endpoint_contract.py"
